...
public class ImGuiRenderer
{
    ...
    public ImGuiRenderer(Game game)
    {
        ...
        ImGuiContextPtr context = Hexa.NET.ImGui.ImGui.CreateContext();
    ...
    {
        Hexa.NET.ImGui.ImGui.GetIO().DeltaTime = (float)gameTime.ElapsedGameTime.TotalSeconds;
        UpdateInput();
    ...
    public virtual void AfterLayout()
    {
        ...
        unsafe
        {
            ImDrawDataPtr drawData = Hexa.NET.ImGui.ImGui.GetDrawData();
    ...
    private unsafe void RenderDrawData(ImDrawData* drawData)
    {
        ...
        drawData->ScaleClipRects(Hexa.NET.ImGui.ImGui.GetIO().DisplayFramebufferScale);
